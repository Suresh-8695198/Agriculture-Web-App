...
import { FaTruck, FaBoxOpen, FaChartBar, FaShoppingCart, FaMapMarkerAlt, FaPhone, FaEnvelope, FaCalendar, FaWarehouse, FaSave, FaTimes } from 'react-icons/fa';
        ...
        <div className="dashboard-container">
            ...
            <div className="dashboard-header">
                <div className="header-content">
                    ...
                    <div className="header-right">
                        <button className="btn-action supplier-btn">
            ...
            <div className="dashboard-content">
                ...
                <div className="content-card profile-card">
                    <div className="card-header supplier-header">
                        <h2>
                            <FaTruck /> Your Business Profile
                        </h2>
                        {!isEditing ? (
                ...
                <div className="content-card activity-card">
                    ...
                    <div className="card-body">
                        <div className="empty-state">
                            <FaShoppingCart />
                            <p>No orders yet</p>
                            <p className="text-muted">Orders from farmers and consumers will appear here</p>
                        </div>
                    </div>
                </div>
            </div>
